...
export const Home = () => {
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans scroll-smooth">
      ...
      <section className="bg-blue-900 text-white pt-16 pb-32 px-6 rounded-b-[40px] md:rounded-b-[80px] text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/register" className="bg-white text-blue-900 px-8 py-5 rounded-2xl font-bold text-xl shadow-xl hover:scale-105 transition-transform text-center">
              Entrar na fila
            </Link>
            <Link to="/login" className="bg-blue-800/50 border-2 border-blue-400 text-white px-8 py-5 rounded-2xl font-bold text-xl hover:bg-blue-800 transition-colors text-center">
              Já tenho conta
            </Link>
          </div>
        </div>
      ...
      <section id="como-funciona" className="-mt-16 px-6 max-w-6xl mx-auto scroll-mt-24">
      ...
      <section className="bg-blue-50 py-20 px-6">
        <div className="max-w-4xl mx-auto bg-blue-900 rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <Link to="/register" className="bg-emerald-500 hover:bg-emerald-600 text-white px-10 py-4 rounded-2xl font-bold text-lg shadow-lg transition-colors text-center">
              Começar agora
            </Link>
      ...
      <footer id="suporte" className="py-12 px-6 border-t border-slate-100 scroll-mt-10">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-6 text-slate-500 text-sm">
            ...
            <a href="mailto:suporte@filazero.com" className="hover:text-blue-600 font-bold transition-colors">Contato</a>
          </div>
        </div>
      </footer>
    </div>
